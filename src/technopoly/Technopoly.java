...
public class Technopoly {
	...
	public static void main(String[] args) {
		...
		System.out.println("The aim is simple; as ruthless CEOs of major Tech firms, it is up to you to lead your respective "
				...
				+ "\nfields is the way to achieve this, for your competitors will need to pay for the privilige of "
				+ "\nlanding on your tiles! Be sure to manage your liquidity however, for if you run out of funds, all "
				+ "\nthe tiles in the world won't prevent bankruptcy and one of your competitors claiming superiority!\n");
	...
	public static void initialiseVars() {	
		...
		try {
			importData.importGameData(gameVars, gameManager.gameBoard, ConfigFile.CONFIG2_FILE);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void takeTurn(Player player) {
		...
		do {
			...
			thread.interrupt(); // stop timer if player makes choice, 
